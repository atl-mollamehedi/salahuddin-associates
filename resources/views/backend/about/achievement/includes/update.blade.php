<div class="modal" id="edit-achieve-{{ $achievement->id }}" tabindex="-1" role="dialog"
    aria-labelledby="exampleModalLabel1">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-success text-white">
                <h4 class="modal-title" id="exampleModalLabel1">Update Your Achievement</h4>
                <br />
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                        aria-hidden="true">&times;</span></button>
            </div>
            <form action="{{ route('backend.achievement.update', $achievement->id) }}" method="post">
                @csrf
                @method('PUT')
                <div class="modal-body text-left">
                    ...
                    <div class="form-group text-left">
                        ...
                        <input type="text" class="form-control" id="message-text1"
                            placeholder="Enter Achievement Name" name="name" value="{{ $achievement->name }}" />
                        @if ($errors->has('name'))
                    ...
                    <div class="form-group text-left">
                        ...
                        <input type="text" value="{{ $achievement->icon }}" class="form-control"
