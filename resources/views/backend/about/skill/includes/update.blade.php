            ...
            <form action="{{ route('backend.skill.update', $skill->id) }}" method="post">
                ...
                <div class="modal-body text-left">
                    @csrf
                        ...
                        <input class="form-control" id="message-text1" placeholder="Enter Skill Name" name="name" value="{{ $skill->name }}" />
                        @if($errors->has('name'))
                    ...
                    <div class="form-group text-left">
                        ...
                        <input class="form-control" id="message-text1" placeholder="Enter Skill Percentage" name="percentage" value="{{ $skill->percentage }}" />
