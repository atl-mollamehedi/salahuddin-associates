            ...
            <form action="{{ route('backend.skill.store') }}" method="post">
                ...
                <div class="modal-body text-left">
                    @csrf
                        ...
                        <input class="form-control" id="message-text1" placeholder="Enter Skill Name" name="name" />
                        @if($errors->has('name'))
                    ...
                    <div class="form-group text-left">
                        ...
                        <input class="form-control" id="message-text1" placeholder="Enter Skill Percentage" name="percentage" />
