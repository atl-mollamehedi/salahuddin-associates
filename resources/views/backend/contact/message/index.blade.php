                                ...
                                <table class="table table-hover no-wrap">
                                    <tbody>
                                        ...
                                        <tr style="background:{{  $message->view_status === 'unread' ? '#e9e9e9;': '' }}">
                                            ...
                                            <td class="max-texts"> <a href="{{ route('backend.contact.details',$message->id) }}" ></span>{{ Str::limit($message->message, 50) }}</td>
                                            ...
                                            <form id="delete-contact-{{$message->id}}" action="{{route('backend.contact.destroy', $message->id)}}" method="POST" style="display: none">
                                                @csrf
                                                @method('delete')
                                            </form> </td>
                                        </tr>
