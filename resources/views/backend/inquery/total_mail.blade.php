                ...
                <div class="col-lg-3 col-md-4">
                    <div class="card-body inbox-panel"><a href="app-compose.html" class="btn btn-danger m-b-20 p-10 btn-block waves-effect waves-light">Compose</a>
                        <ul class="list-group list-group-full">
                            <li class="list-group-item"> <a href="{{ route('backend.inquery.index') }}"><i class="mdi mdi-gmail"></i> Inbox </a></li>
                                ...
                                <table class="table table-hover no-wrap">
                                    <tbody>
                                        ...
                                        <tr style="background:{{  $message->view_status === 'unread' ? '#e9e9e9;': '' }}">
                                            ...
                                            <td class="max-texts"> <a href="{{ route('backend.inquery.details',$message->id) }}" >{{  $message->email }}</td>
                                            <td class="hidden-xs-down"><a class="btn p-3 btn-sm text-white btn-info" href="mailto:{{  $message->email }}">compose</a></td>
