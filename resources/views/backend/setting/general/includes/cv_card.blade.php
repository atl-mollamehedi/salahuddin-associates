<div class="card">
    <div class="card-body">
        ...
        <a download href="{{  asset(setting()->cv) }}" class="btn btn-info">Download Your Company Profile</a> 
        <div class="modal" id="general_cv" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-success text-white">
                        <h4 class="modal-title" id="exampleModalLabel1">Update Your Company Profile</h4>
