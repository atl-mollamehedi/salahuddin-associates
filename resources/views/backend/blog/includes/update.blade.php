            ...
            <form action="{{ route('backend.blog.update', $blog->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body text-left">
                    ...
                    <div class="form-group text-left">
                        ...
                        <textarea class="form-control" rows='7' id="message-text1" placeholder="Enter your Description" name="description">{{ $blog->description }}</textarea>
                    </div>
                    ...
                    <div class="form-group text-left {{ $blog->type == 2 ? ' ' : 'display__none' }} u_blog__text">
                        ...
                        <textarea class="form-control" rows='7' id="message-text1" placeholder="Enter your blog link" name="link">{{ $blog->link }}</textarea>
                    </div>
                    <div
