            ...
            <form action="{{ route('backend.review.update', $review->id) }}" method="post"
                ...
                <div class="modal-body text-left">
                    ...
                    <div class="form-group text-left {{ $review->type == 2 ? ' ' : 'display__none' }} u_review__text">
                        ...
                        <textarea class="form-control" rows='7' id="message-text1" placeholder="Enter your Review" name="review_text">{{ $review->review_text }}</textarea>
                    </div>
                    <div
                        ...
                        <input type="file" name="review_photo"
                            value="{{ $review->review_photo }}" class="" data-height="150"
