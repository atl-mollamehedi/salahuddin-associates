            ...
            <div class="row m-0">
                    ...
                    <div class="hero-caption w-75 carousel-nav">
                        <div class="experience_slide banner_slider_img  owl-carousel">
                            <div class="experience_item">
                                <h4 class="left-border-s text-white">{{ __('Experience
                                    ') }}</h4>
                        ...
                        <ul style="list-style:circle;color:rgb(255, 255, 255);padding:10px 0px 10px 45px">
                            ...
                            <div class="experience_item">
                                <h4 class="left-border-s text-white">{{ __('Existence
                                    ') }}</h4>
                                <h2 class=" text-white"> >Construction </h2>
                                <ul style="list-style:circle;color:rgb(255, 255, 255);padding:10px 0px 10px 45px">
                ...
                <div class="col-lg-6 align-self-end p-0">
                    ...
                    <div class="banner_slider_img  owl-carousel">
                        <img src="{{ asset('uploads/experience/bank-financial-ins.jpg') }}" alt="img" class="img-fluid">
                        <img src="{{ asset('uploads/experience/communication.jpg') }}" alt="img" class="img-fluid">
                        <img src="{{ asset('uploads/experience/manufacturing.jpg') }}" alt="img" class="img-fluid">
                        <img src="{{ asset('uploads/experience/energy-power.jpg') }}" alt="img" class="img-fluid">
                        <img src="{{ asset('uploads/experience/construction.jpg') }}" alt="img" class="img-fluid">
                        ...
                        <img src="{{ asset('uploads/experience/construction1.jpg') }}" alt="img" class="img-fluid">
                        <img src="{{ asset('uploads/experience/manufacturing1.jpg') }}" alt="img" class="img-fluid">
                        <img src="{{ asset('uploads/experience/energy-power1.jpg') }}" alt="img" class="img-fluid">
